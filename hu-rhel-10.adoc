...
summary: Installez les utilitaires hôtes Linux sur un hôte RHEL 10 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP . 
---
= Configurer RHEL 10 pour FCP et iSCSI avec le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser le multipathing avec RHEL 10 pour gérer les LUN ONTAP .
