...
summary: Installez les utilitaires hôtes Linux sur un serveur SUSE Linux Enterprise Server 15 SP7 pour gérer les opérations de protocole FCP et iSCSI avec des LUN ONTAP. 
---
= Configurer SUSE Linux Enterprise Server 15 SPx pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le logiciel Linux Host Utilities fournit des outils de gestion et de diagnostic pour les hôtes Linux connectés au stockage ONTAP . Lorsque vous installez les utilitaires hôtes Linux sur un hôte SUSE Linux Enterprise Server 15 SPx, vous pouvez utiliser ces utilitaires pour vous aider à gérer les opérations des protocoles FCP et iSCSI avec les LUN ONTAP .
...
Vous pouvez utiliser le multipathing avec SUSE Linux Enterprise Server 15 SPx pour gérer les LUN ONTAP .
...
SUSE Linux Enterprise Server 15 SPx avec stockage ONTAP présente les problèmes connus suivants.
