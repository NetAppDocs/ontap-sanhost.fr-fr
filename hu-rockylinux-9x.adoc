...
Pour vous assurer que le multipathing est correctement configuré pour votre hôte, définissez le `timeout` paramètre sur votre hôte et vérifiez que le service iSCSI est en cours d'exécution et se connecte aux cibles iSCSI.
