...
summary: Installez les utilitaires hôtes Linux sur un serveur SUSE Linux Enterprise Server 12 SP5 pour gérer les opérations de protocole FCP et iSCSI avec des LUN ONTAP. 
---
