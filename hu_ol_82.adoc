...
---
= Utilisez Oracle Linux 8.2 avec ONTAP
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
:toclevels: 1P
...
[role="lead"]
Vous pouvez utiliser les paramètres de configuration de l'hôte SAN ONTAP pour configurer Oracle Linux 8.2 avec ONTAP comme cible.
...
NOTE: Pour configurer Oracle Linux 8.2 Red Hat Enterprise Kernel (RHCK), utilisez link:hu_rhel_82.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.2.



== Problèmes connus

Il n'y a aucun problème connu pour Oracle Linux 8.2 avec la version ONTAP.


NOTE: Pour connaître les problèmes connus liés à Oracle Linux (noyau compatible Red Hat), consultez le document link:hu_rhel_82.html#known-problems-and-limitations["problèmes connus"]for Red Hat Enterprise Linux (RHEL) 8.2.
