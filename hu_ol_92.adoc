...
NOTE: Pour configurer Oracle Linux 9.2 Red Hat Enterprise Kernel (RHCK), utilisez link:hu_rhel_92.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 9.2.
