...
summary: Installez Linux Host Utilities sur un hôte RHEL 7.9 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP. 
---
= Configurez RHEL 7.9 pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser les chemins d'accès multiples avec RHEL 7.9 pour gérer les LUN ONTAP.
...
La version RHEL 7.9 avec stockage ONTAP présente le problème connu suivant :
