...
NOTE: Pour configurer Oracle Linux 8.8 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_88.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 8.8.
