...
--
.Étapes
. Vérifiez que vous utilisez la carte prise en charge. Pour plus d'informations sur les cartes prises en charge, reportez-vous au link:https://mysupport.netapp.com/matrix/["Matrice d'interopérabilité NetApp"^].
+
[listing]
----
...
.Marvell/QLogic
--
Le pilote natif qla2xxx inclus dans le noyau RHEL 9.0 dispose des derniers correctifs, essentiels pour la prise en charge de ONTAP.
