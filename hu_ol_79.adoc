...
NOTE: Pour configurer Oracle Linux 7.9 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_79.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 7.9.
