...
* Pour accéder au rapport TR-4597-VMware vSphere avec ONTAP, reportez-vous à link:https://cert.vmware.com/caas/support/case/00088028["Cas client-00088028"^] et link:https://cert.vmware.com/caas/support/case/00088029["Cas client-00088029"^]
