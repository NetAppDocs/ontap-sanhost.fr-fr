...
Pour les problèmes connus liés à CentOS (noyau compatible Red Hat), consultez le link:hu_rhel_64.html#known-problems-and-limitations["problèmes connus"] Pour Red Hat Enterprise Linux (RHEL) 6.4.
