...
summary: Installez Linux Host Utilities sur un SUSE Linux Enterprise Server 15 SP5 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP. 
---
