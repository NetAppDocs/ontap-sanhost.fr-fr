...
summary: Installez les utilitaires hôtes Linux sur un serveur SUSE Linux Enterprise Server 15 SP5 pour gérer les opérations de protocole FCP et iSCSI avec des LUN ONTAP. 
---
= Configurez SUSE Linux Enterprise Server 15 SP5 pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le logiciel Linux Host Utilities fournit des outils de gestion et de diagnostic pour les hôtes Linux connectés au stockage ONTAP. Lorsque vous installez les utilitaires d'hôtes Linux sur un hôte SUSE Linux Enterprise Server 15 SP5, vous pouvez utiliser les utilitaires d'hôtes pour vous aider à gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP.
...
Vous pouvez utiliser les chemins d'accès multiples avec SUSE Linux Enterprise Server 15 SP5 pour gérer les LUN ONTAP.
