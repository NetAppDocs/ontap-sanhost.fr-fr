...
---
= Référence de commande Linux Host Utilities 7.1
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Vous pouvez utiliser l'exemple de référence de commande des utilitaires d'hôtes Linux 7.1 pour valider de bout en bout la configuration de stockage NetApp à l'aide de l'outil Utilitaires hôtes.
