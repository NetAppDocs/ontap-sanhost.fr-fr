...
[role="lead"]
Les configurations hôte SAN de NetApp prennent en charge le protocole NVMe over Fabrics (NVMe-of) sur Oracle Linux 8.10 avec ANA (Asymmetric Namespace Access).
