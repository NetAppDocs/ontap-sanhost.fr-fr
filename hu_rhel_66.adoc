...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=852674["1076584"^] | Blocage des E/S jusqu'à 300 s constaté avec l'hôte QLogic 16G FC (QLE2672) lors des défaillances de stockage dans RHEL 6U4 | Vous pouvez observer un blocage des E/S jusqu'à 300 s sur un hôte QLogic 16G FC (QLE2672) pendant les pannes de structure/stockage. 
