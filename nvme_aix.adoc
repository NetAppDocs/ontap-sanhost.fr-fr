...
Avant de dépanner toute panne NVMe/FC, vérifiez que vous exécutez une configuration conforme aux spécifications IMT.
Si les problèmes persistent, contactez le support technique pour un triage plus approfondi.
