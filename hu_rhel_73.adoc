...
summary: Installez Linux Host Utilities sur un hôte RHEL 7.3 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP. 
---
= Configurez RHEL 7.3 pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser les chemins d'accès multiples avec RHEL 7.3 pour gérer les LUN ONTAP.
