...
NOTE: Pour configurer Oracle Linux 7.4 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_74.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 7.4.
