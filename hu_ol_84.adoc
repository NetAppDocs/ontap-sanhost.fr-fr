...
summary: Installez Linux Host Utilities sur un hôte Oracle Linux 8.4 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP. 
---
= Configurer Oracle Linux 8.4 pour FCP et iSCSI avec le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser les chemins d'accès multiples avec Oracle Linux 8.4 pour gérer les LUN ONTAP.


NOTE: Vous pouvez utiliser le link:hu_rhel_84.html#rhel-rhck["paramètres recommandés pour Red Hat Enterprise Linux (RHEL) 8.4"] pour configurer le noyau compatible Red Hat pour Oracle Linux 8.4.
