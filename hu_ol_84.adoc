...
NOTE: Pour configurer Oracle Linux 8.4 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_84.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.4.
...
NOTE: Pour connaître les problèmes connus liés à Oracle Linux RHCK, reportez-vous à la link:hu_rhel_84.html#known-problems-and-limitations["problèmes connus"] section de la documentation relative à la version RHEL correspondante.
