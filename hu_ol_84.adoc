...
NOTE: Pour connaître les problèmes connus liés à Oracle Linux (noyau compatible Red Hat), consultez la link:hu_rhel_84.html#known-problems-and-limitations["problèmes connus"] section de la documentation de la version Red Hat Enterprise Linux correspondante.
