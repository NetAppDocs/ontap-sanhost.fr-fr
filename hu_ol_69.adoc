...
NOTE: Pour configurer Oracle Linux 6.9 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_69.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 6.9.
