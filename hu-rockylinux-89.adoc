...
summary: Installez Linux Host Utilities sur un hôte Rocky Linux 8.9 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP. 
---
...
[role="lead"]
Le logiciel Linux Host Utilities fournit des outils de gestion et de diagnostic pour les hôtes Linux connectés au stockage ONTAP. Lorsque vous installez Linux Host Utilities sur un hôte Rocky Linux 8.9, vous pouvez utiliser Host Utilities pour vous aider à gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP.
