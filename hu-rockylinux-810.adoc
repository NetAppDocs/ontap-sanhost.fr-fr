...
summary: 'Installez les utilitaires d"hôte Linux sur un hôte Rocky Linux 8.10 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP.' 
---
= Configurer Rocky Linux 8.10 pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le logiciel Linux Host Utilities fournit des outils de gestion et de diagnostic pour les hôtes Linux connectés au stockage ONTAP. Lorsque vous installez les utilitaires d'hôte Linux sur un hôte Rocky Linux 8.10, vous pouvez utiliser les utilitaires d'hôte pour vous aider à gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP.
...
Vous pouvez utiliser le multipathing avec Rocky Linux 8.10 pour gérer les LUN ONTAP.
