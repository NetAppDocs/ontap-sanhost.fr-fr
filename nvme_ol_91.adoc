...
--
Le pilote natif de la boîte de réception qla2xxx inclus dans le noyau OL 9.1 GA possède les derniers correctifs en amont. Ces correctifs sont essentiels à la prise en charge de ONTAP.
