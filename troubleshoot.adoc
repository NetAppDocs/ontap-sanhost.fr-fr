...
Si le problème persiste, collectez les fichiers et les résultats des commandes suivants et contactez link:https://mysupport.netapp.com["Support NetApp"^] pour un diagnostic plus approfondi :
