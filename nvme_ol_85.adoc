...
Avant de procéder au dépannage en cas de panne NVMe/FC, assurez-vous que vous exécutez une configuration conforme aux spécifications IMT, puis passez aux étapes suivantes pour corriger tout problème côté hôte.
