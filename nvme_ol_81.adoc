...
* Il n'y a pas de prise en charge sanlun pour NVMe/FC et, par conséquent, aucun utilitaire d'hôte Linux ne prend en charge NVMe/FC sur Oracle Linux 8.1. Utilisez la sortie de la commande ONTAP disponible dans le cadre du plug-in NetApp inclus dans l'interface de ligne de commande native nvme.
