...
summary: 'Installez les utilitaires d"hôtes Linux sur un hôte RHEL 8.9 pour gérer les opérations de protocole FCP et iSCSI avec des LUN ONTAP.' 
---
= Configurez RHEL 8.9 pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser les chemins d'accès multiples avec RHEL 8.9 pour gérer les LUN ONTAP.
