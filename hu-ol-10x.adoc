...
summary: Installez les utilitaires hôtes Linux sur un hôte Oracle Linux 10.x pour gérer les opérations de protocole FCP et iSCSI avec les LUNs ONTAP. 
---
= Configurer Oracle Linux 10.x pour FCP et iSCSI avec le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le logiciel Linux Host Utilities fournit des outils de gestion et de diagnostic pour les hôtes Linux connectés au stockage ONTAP. Lorsque vous installez Linux Host Utilities sur un hôte Oracle Linux 10.x, vous pouvez utiliser Host Utilities pour vous aider à gérer les opérations des protocoles FCP et iSCSI avec les LUN ONTAP.
...
Vous pouvez utiliser le multipathing avec Oracle Linux 10.x pour gérer les LUN ONTAP.
