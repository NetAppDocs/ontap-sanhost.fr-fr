...
summary: Installez Linux Host Utilities sur un hôte CentOS 7.7 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP . 
---
= Configurer CentOS 7.7 pour FCP et iSCSI pour le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser le multipathing avec CentOS 7.7 pour gérer les LUN ONTAP.
...
L'hôte CentOS 7.7 avec stockage ONTAP présente les problèmes connus suivants :
