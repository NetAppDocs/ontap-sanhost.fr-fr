...
[role="lead"]
Configurez Ubuntu 24.04 pour le multi-accès et avec des paramètres et paramètres spécifiques pour le fonctionnement FCP et iSCSI avec le stockage ONTAP .
