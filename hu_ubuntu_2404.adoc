...
summary: Installez Linux Host Utilities sur un hôte Ubuntu 24.04 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP . 
---
= Configurer Ubuntu 24.04 pour FCP et iSCSI avec le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le logiciel Linux Host Utilities fournit des outils de gestion et de diagnostic pour les hôtes Linux connectés au stockage ONTAP .  Lorsque vous installez les utilitaires d'hôte Linux sur un hôte Ubuntu 24.04, vous pouvez utiliser les utilitaires d'hôte pour vous aider à gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP .
...
Vous pouvez utiliser le multipathing avec Ubuntu 24.04 pour gérer les LUN ONTAP .
