...
--
.Étapes
. Le pilote natif qla2xxx inclus dans le noyau RHEL 9.3 GA dispose des derniers correctifs essentiels à la prise en charge de ONTAP. Vérifiez que vous exécutez les versions du pilote de carte et du micrologiciel prises en charge :
+
[listing]
----
