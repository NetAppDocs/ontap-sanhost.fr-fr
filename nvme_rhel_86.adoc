...
Pour passer confortablement en cas d'événements de basculement ONTAP tels que les SFO, il est conseillé de définir une période de tentatives plus longue de 30 minutes en ajustant le `ctrl_loss_tmo` minuterie. Voici les détails :
