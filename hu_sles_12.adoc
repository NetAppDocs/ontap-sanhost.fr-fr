...
summary: Installez Linux Host Utilities sur un serveur SUSE Linux Enterprise Server 12 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP. 
---
= Configurez SUSE Linux Enterprise Server 12 pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le logiciel Linux Host Utilities fournit des outils de gestion et de diagnostic pour les hôtes Linux connectés au stockage ONTAP. Lorsque vous installez les utilitaires hôtes Linux sur un hôte SUSE Linux Enterprise Server 12, vous pouvez utiliser les utilitaires hôtes pour vous aider à gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP.
...
Vous pouvez utiliser les chemins d'accès multiples avec SUSE Linux Enterprise Server 12 pour gérer les LUN ONTAP.
...
La version SUSE Linux Enterprise Server 12 avec stockage ONTAP présente les problèmes connus suivants :
