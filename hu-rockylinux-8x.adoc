...
summary: Installez Linux Host Utilities sur un hôte Rocky Linux 8.10 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP. 
---
= Configurer Rocky Linux 8.x pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser le multipathing avec Rocky Linux 8.x pour gérer les LUN ONTAP .
