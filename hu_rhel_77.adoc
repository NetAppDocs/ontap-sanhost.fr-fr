...
---
= Utilisez Red Hat Enterprise Linux 7.7 avec ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Vous pouvez utiliser les paramètres de configuration de l'hôte SAN ONTAP pour configurer Red Hat Enterprise Linux 7.7 avec ONTAP comme cible.
...
La version RHEL 7.7 avec ONTAP présente les problèmes connus suivants :
