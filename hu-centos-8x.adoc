...
Pour les problèmes connus du noyau compatible CentOS Red Hat, consultez la documentation. link:hu-rhel-8x.html#known-problems-and-limitations["problèmes connus"] pour la série Red Hat Enterprise Linux (RHEL) 8.x.
