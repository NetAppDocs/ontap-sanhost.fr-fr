...
---
= Utilisez Oracle Linux 6.5 avec ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Vous pouvez utiliser les paramètres de configuration de l'hôte SAN ONTAP pour configurer Oracle Linux 6.5 avec ONTAP comme cible.
...
NOTE: Pour configurer Oracle Linux 6.5 Red Hat Enterprise Kernel (RHCK), utilisez link:hu_rhel_65.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 6.5.



== Problèmes connus

Il n'y a aucun problème connu pour Oracle Linux 6.5 avec la version ONTAP.
