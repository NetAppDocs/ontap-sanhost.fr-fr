...
* Nous ne prenons pas en charge Sanlunn pour NVMe-of. Par conséquent, il n'existe pas de prise en charge d'utilitaires hôtes pour NVMe-of sur un hôte Oracle Linux 8.9. Vous pouvez utiliser le plug-in NetApp inclus dans le pack natif `nvme-cli` pour tous les transports NVMe-of.
