...
NOTE: Pour configurer Oracle Linux 8.3 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_83.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.3.
...
NOTE: Pour connaître les problèmes connus liés à Oracle Linux RHCK, reportez-vous à la link:hu_rhel_83.html#known-problems-and-limitations["problèmes connus"] section de la documentation relative à la version RHEL correspondante.
