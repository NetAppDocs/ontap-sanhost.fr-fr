...
---
= Utilisez Oracle Linux 8.3 avec ONTAP
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
:toclevels: 1P
...
[role="lead"]
Vous pouvez utiliser les paramètres de configuration de l'hôte SAN ONTAP pour configurer Oracle Linux 8.3 avec ONTAP comme cible.
...
NOTE: Pour configurer Oracle Linux 8.3 Red Hat Enterprise Kernel (RHCK), utilisez link:hu_rhel_83.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.3.



== Problèmes connus

Il n'y a aucun problème connu pour Oracle Linux 8.3 avec la version ONTAP.


NOTE: Pour connaître les problèmes connus liés à Oracle Linux (noyau compatible Red Hat), consultez la link:hu_rhel_83.html#known-problems-and-limitations["problèmes connus"] section de la documentation de la version Red Hat Enterprise Linux correspondante.
