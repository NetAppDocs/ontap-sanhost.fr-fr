...
NOTE: Pour configurer Oracle Linux 7.1 Red Hat Enterprise Kernel (RHCK), utilisez link:hu_rhel_71.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 7.1.
