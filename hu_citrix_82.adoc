...
summary: Configurez Citrix Hypervisor 8.2 pour le multi-accès et avec des paramètres et paramètres spécifiques pour les opérations de protocole FCP et iSCSI avec le stockage ONTAP . 
---
