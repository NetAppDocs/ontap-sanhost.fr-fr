...
* Nous ne prenons pas en charge Sanlunn pour NVMe-of. Par conséquent, il n'existe pas de support d'utilitaire hôte pour NVMe-of sur un hôte OL 8.8. Vous pouvez utiliser le plug-in NetApp inclus dans le pack natif `nvme-cli` pour tous les transports NVMe-of.
