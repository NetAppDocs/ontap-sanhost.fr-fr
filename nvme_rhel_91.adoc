...
. Une fois l'installation terminée, vérifiez que vous exécutez le noyau RHEL 9.1 spécifié. Voir link:https://mysupport.netapp.com/matrix/["Matrice d'interopérabilité"^]pour la liste actuelle des versions prises en charge.
+
Exemple :
