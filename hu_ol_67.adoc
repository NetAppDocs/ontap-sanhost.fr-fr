...
NOTE: Pour configurer Oracle Linux 6.7 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_67.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 6.7.
