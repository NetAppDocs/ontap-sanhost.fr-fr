...
NOTE: Pour configurer Oracle Linux 6.7 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_67.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 6.7.
...
NOTE: Pour connaître les problèmes connus liés à Oracle Linux RHCK, consultez le link:hu_rhel_67.html#known-problems-and-limitations["problèmes connus"] pour RHEL 6.7.
