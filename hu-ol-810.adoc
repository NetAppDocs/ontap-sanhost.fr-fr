...
NOTE: Pour configurer Oracle Linux 8.10 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_810.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.10.
