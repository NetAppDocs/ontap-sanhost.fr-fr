...
Il n'est pas nécessaire de configurer les paramètres d'une machine virtuelle basée sur kernel sous Oracle Linux 8.10 car la LUN est mappée sur l'hyperviseur.
