...
NOTE: Pour configurer Oracle Linux 8.9 RedHat Enterprise Kernel, utilisez link:hu_rhel_88.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.9.
