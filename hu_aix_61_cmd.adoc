...
[role="lead"]
Vous pouvez utiliser la référence de commande AIX Host Utilities 6.1 pour une validation de bout en bout de la configuration de stockage NetApp à l'aide de l'outil Host Utilities.
