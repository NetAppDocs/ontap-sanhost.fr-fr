...
summary: Installez Linux Host Utilities sur un hôte CentOS 8.5 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP . 
---
= Configurer CentOS 8.5 pour FCP et iSCSI pour le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser le multipathing avec CentOS 8.5 pour gérer les LUN ONTAP.
