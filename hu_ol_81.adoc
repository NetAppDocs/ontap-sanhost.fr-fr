...
NOTE: Pour configurer Oracle Linux 8.1 Red Hat Enterprise Kernel (RHCK), utilisez link:hu_rhel_81.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.1.
...
NOTE: Pour connaître les problèmes connus liés à Oracle Linux (noyau compatible Red Hat), consultez le document link:hu_rhel_81.html#known-problems-and-limitations["problèmes connus"]for Red Hat Enterprise Linux (RHEL) 8.1.
