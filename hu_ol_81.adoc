...
NOTE: Pour configurer Oracle Linux 8.1 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_81.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 8.1.
...
NOTE: Pour les problèmes connus liés à Oracle Linux (noyau compatible Red Hat), consultez le link:hu_rhel_81.html#known-problems-and-limitations["problèmes connus"] Pour Red Hat Enterprise Linux (RHEL) 8.1.
