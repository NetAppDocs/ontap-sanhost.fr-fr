...
NOTE: Pour configurer Oracle Linux 6.8 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_68.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 6.8.
