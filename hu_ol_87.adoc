...
---
= Utilisation d'Oracle Linux 8.7 avec NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: Pour configurer Oracle Linux 8.7 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_87.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 8.7.
...
Il n'y a aucun problème connu pour Oracle Linux 8.7.
