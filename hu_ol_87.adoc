...
Les sections suivantes fournissent des exemples de sorties multivoies pour une LUN mappée sur toutes les configurations ASA (baie SAN) et non ASA.
...
NOTE: Pour configurer Oracle Linux 8.7 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_87.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.7.
