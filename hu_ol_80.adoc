...
---
= Utilisation d'Oracle Linux 8.0 avec NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Pour configurer Oracle Linux 8.0 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_80.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 8.0.



== Problèmes connus et limites

Il n'y a aucun problème connu pour Oracle Linux 8.0.


NOTE: Pour les problèmes connus liés à Oracle Linux (noyau compatible Red Hat), consultez le link:hu_rhel_80.html#known-problems-and-limitations["problèmes connus"] Pour Red Hat Enterprise Linux (RHEL) 8.0.
