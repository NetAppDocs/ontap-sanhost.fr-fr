...
NOTE: Pour configurer Oracle Linux 8.0 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_80.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 8.0.
...
NOTE: Pour connaître les problèmes connus liés à Oracle Linux RHCK, consultez le link:hu_rhel_80.html#known-problems-and-limitations["problèmes connus"] pour RHEL 8.0.
