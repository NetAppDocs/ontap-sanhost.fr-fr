...
---
= Utilisez les commandes des utilitaires hôtes Solaris pour vérifier la configuration du stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Vous pouvez utiliser l'exemple de référence de commande Solaris Host Utilities pour une validation de bout en bout de la configuration de stockage NetApp à l'aide de l'outil Host Utilities.
...
.8.0
--
.Afficher un exemple pour Solaris Host Utilities 8.0
[%collapsible]
=====
[listing]
----
...
.6,2
--
.Afficher un exemple pour Solaris Host Utilities 6.2
[%collapsible]
=====
[listing]
----
...
Vous pouvez récupérer une liste de tous les LUN mappés à un hôte à partir d'un SVM spécifique.
