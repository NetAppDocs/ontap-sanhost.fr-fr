...
[role="lead"]
Vous pouvez utiliser l'exemple de référence de commande HP-UX Host Utilities 6.0 pour une validation de bout en bout de la configuration de stockage ONTAP à l'aide de l'outil Utilitaires hôtes.
