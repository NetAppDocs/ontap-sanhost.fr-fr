...
---
= Référence de la commande HP-UX Host Utilities 6.0
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Vous pouvez utiliser l'exemple de référence de commande HP-UX Unified Host Utilities 6.0 pour une validation de bout en bout de la configuration de stockage NetApp à l'aide de l'outil Host Utilities.
...
Vous pouvez récupérer la liste de toutes les LUN mappées sur l'hôte à partir d'un SVM spécifique.
...
Vous pouvez récupérer une liste d'attributs de LUN ONTAP par un nom de fichier de périphérique hôte spécifié.
