...
summary: Installez Linux Host Utilities sur un hôte CentOS 8.2 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP . 
---
= Configurer CentOS 8.2 pour FCP et iSCSI pour le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser le multipathing avec CentOS 8.2 pour gérer les LUN ONTAP.
...
Il n'y a aucun problème connu pour CentOS 8.2 pour FCP et iSCSI avec le stockage ONTAP.

Pour les problèmes connus du noyau compatible CentOS Red Hat, consultez le link:hu_rhel_82.html#known-problems-and-limitations["problèmes connus"] pour Red Hat Enterprise Linux (RHEL) 8.2.
