...
---
= Utilisation de Red Hat Enterprise Linux 8.2 avec NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Pour Red Hat Enterprise Linux (RHEL) 8.2, le fichier /etc/multipath.conf doit exister, mais vous n'avez pas besoin d'apporter de modifications spécifiques au fichier. RHEL 8.2 est compilé avec tous les paramètres requis pour reconnaître et gérer correctement les LUN ONTAP.
...
Il n'y a aucun problème connu pour RHEL 8.2.
