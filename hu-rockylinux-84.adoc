...
summary: 'Installez les utilitaires d"hôte Linux sur un hôte Rocky Linux 8.4 pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP.' 
---
= Configurer Rocky Linux 8.4 pour FCP et iSCSI avec le stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser le multipathing avec Rocky Linux 8.4 pour gérer les LUN ONTAP.
