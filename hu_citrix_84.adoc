...
summary: Configurez Citrix Xenserver 8.4 pour le multivoie et avec des paramètres et paramètres spécifiques pour les opérations de protocole FCP et iSCSI avec le stockage ONTAP . 
---
...
[role="lead"]
Configurez Citrix Xenserver 8.4 pour le multivoie et avec des paramètres et paramètres spécifiques pour les opérations de protocole FCP et iSCSI avec le stockage ONTAP .

[NOTE]
====
Le progiciel Linux Host Utilities ne prend pas en charge les systèmes d'exploitation Citrix Xenserver.
...
Vous pouvez utiliser le multipathing avec Citrix Xenserver 8.4 pour gérer les LUN ONTAP .
