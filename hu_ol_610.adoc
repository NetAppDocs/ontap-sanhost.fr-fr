...
NOTE: Pour configurer Oracle Linux 6.10 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_610.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 6.10.
