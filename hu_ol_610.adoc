...
NOTE: Pour configurer Oracle Linux 6.10 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_610.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 6.10.
...
NOTE: Pour connaître les problèmes connus liés à Oracle Linux RHCK, consultez le link:hu_rhel_610.html#known-problems-and-limitations["problèmes connus"] pour RHEL 6.10.
