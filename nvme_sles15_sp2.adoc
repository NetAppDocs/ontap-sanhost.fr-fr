...
[role="lead"]
NVMe/FC est pris en charge sur ONTAP 9.6 et versions ultérieures avec SUSE Linux Enterprise Server 15 SP2. L'hôte SUSE Linux Enterprise Server 15 SP2 peut exécuter le trafic NVMe/FC et FCP via les mêmes ports d'adaptateur d'initiateur Fibre Channel. Consultez la link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] pour obtenir la liste des adaptateurs et contrôleurs FC pris en charge.
