...
NOTE: Pour configurer Oracle Linux 9.0 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_86.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 9.0.
