...
summary: Configurez Ubuntu 20.04 pour le multi-accès et avec des paramètres et paramètres spécifiques pour le fonctionnement FCP et iSCSI avec le stockage ONTAP . 
---
...
[role="lead"]
Configurez Ubuntu 20.04 pour le multi-accès et avec des paramètres et paramètres spécifiques pour le fonctionnement FCP et iSCSI avec le stockage ONTAP .
