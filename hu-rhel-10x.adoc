...
summary: Installez les utilitaires hôtes Linux sur un hôte RHEL 10.x pour gérer les opérations de protocole FCP et iSCSI avec les LUN ONTAP . 
---
= Configurer RHEL 10.x pour FCP et iSCSI avec stockage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez utiliser le multipathing avec RHEL 10.x pour gérer les LUN ONTAP .
