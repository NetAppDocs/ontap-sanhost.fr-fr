...
NOTE: Pour configurer Oracle Linux 7.2 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_72.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 7.2.
