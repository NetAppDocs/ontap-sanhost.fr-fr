...
NOTE: Pour configurer Oracle Linux 9.1 RedHat Enterprise Kernel (RHCK), utilisez le link:hu_rhel_91.html#recommended-settings["paramètres recommandés"] Pour Red Hat Enterprise Linux (RHEL) 9.1.
