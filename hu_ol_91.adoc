...
NOTE: Pour configurer Oracle Linux 9.1 Red Hat compatible Kernel (RHCK), utilisez link:hu_rhel_91.html#recommended-settings["paramètres recommandés"]pour Red Hat Enterprise Linux (RHEL) 9.1.
