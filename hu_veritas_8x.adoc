...
---
= Utiliser Veritas Infoscale 8 pour Linux avec NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Ce document fournit des conseils sur les paramètres de configuration des hôtes SAN ONTAP pour la version 8 de Veritas Infoscale Storage based pour les plateformes Red Hat Enterprise Linux et Oracle Linux (basées sur RHCK) avec protocoles FC, FCoE et iSCSI.
