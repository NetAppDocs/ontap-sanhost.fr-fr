...
---
= Utilisation de Red Hat Enterprise Linux 9.1 avec NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
L'installation de Linux Unified Host Utilities est fortement recommandée par NetApp, mais elle n'est pas obligatoire. Les utilitaires ne modifient aucun paramètre sur votre hôte Linux. Ces utilitaires améliorent la gestion et aident le support client NetApp à collecter des informations sur votre configuration.
